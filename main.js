...
yesBtn.addEventListener("click", () => {
  question.innerHTML = "I'm SORRY ❤️<br><br>🙏 Aurat toh bhagwan ka masterpiece hai.";
...
gif.style.width = "400px"; 
  ...
  yesBtn.addEventListener("click", () => {
    question.innerHTML = "Hehehe!! I knew It ❤️<br><br>🙏 Jai Aurat Devi! Ab kabhi disrespect wali baat nahi karunga.";
  ...
  noBtn.addEventListener("click", () => {
    question.innerHTML = "Soch lo acche se! 😅<br><br>🌹 Jahan naari ka samman hota hai, wahan sukh-shanti hoti hai.";
    ...
    noBtn.addEventListener("click", () => {
      question.innerHTML = "Ak baar aur soch lo 🥺<br><br>🌹 Aapke pair chhoo lu toh mandir jaane ki zarurat hi nahi padegi.";
      ...
      noBtn.addEventListener("click", () => {
        question.innerHTML = "Manja nah! kitna bhav khayegi 😂<br><br>✨ Aurat ka respect mandatory hai, optional nahi.";
